...
ssa_cpp_pest <- function(rnet_xptr, y, T, trajectories = 1L, k_vec = NULL, seed_val = NULL) {
    .Call(`_rendr_ssa_cpp_pest`, rnet_xptr, y, T, trajectories, k_vec, seed_val)
}
...
ssa_cpp_count <- function(rnet_xptr, y, T, k_vec = NULL, seed_val = NULL) {
    .Call(`_rendr_ssa_cpp_count`, rnet_xptr, y, T, k_vec, seed_val)
}
